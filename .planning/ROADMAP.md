...
**Plans**: 6 plans
  - [ ] 12-01-PLAN.md — Create agent/providers.py (Protocol + ToolsLambdaProvider + InMemoryProvider + SalesforceCustomerDataProvider + set_provider/get_provider)
  - [ ] 12-02-PLAN.md — Add lambda/handler.py action dispatcher + update CDK handler string to handler.handler
  - [ ] 12-03-PLAN.md — Create scripts/capture_live_recommendations.py + capture baseline/pre/ JSONs from live v2.0 runtime
  - [ ] 12-04-PLAN.md — Add tests/test_providers.py + _provider_swap autouse fixture (D-09 pre-deploy gate)
...
| 12. CustomerDataProvider Abstraction | v3.0 | 0/6 | Planned      | — |
