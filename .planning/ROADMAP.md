...
- [x] 13.1-02-PLAN.md — Offline regression guards: `MockedModelProvider(Model)` + `TestShortCircuit` + `TestEmptyBillingStop` + `TestCrossPersonaCanary` shape extension (D-13.1-03/04/09/15)
